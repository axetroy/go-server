...
import (
	...
	"gitlab.com/axetroy/server/controller/downloader"
	"gitlab.com/axetroy/server/controller/email"
	"gitlab.com/axetroy/server/controller/finance"
	"gitlab.com/axetroy/server/controller/invite"
	"gitlab.com/axetroy/server/controller/news"
	"gitlab.com/axetroy/server/controller/resource"
	"gitlab.com/axetroy/server/controller/static"
	"gitlab.com/axetroy/server/controller/transfer"
	"gitlab.com/axetroy/server/controller/uploader"
	"gitlab.com/axetroy/server/controller/user"
	"gitlab.com/axetroy/server/controller/wallet"
	"gitlab.com/axetroy/server/middleware"
	"net/http"
)
