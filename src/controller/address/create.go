...
type CreateAddressParams struct {
	...
	ProvinceCode int32  `json:"province_code" valid:"required~请选择省份"` // 省份代码
	CityCode     int32  `json:"city_code" valid:"required~请选择城市"`     // 城市代码
	AreaCode     int32  `json:"area_code" valid:"required~请选择区域"`     // 区域代码
