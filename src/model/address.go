...
type Address struct {
	...
	ProvinceCode int32  `gorm:"not null;index;type:varchar(32)" json:"province_code"`         // 省份代码
	CityCode     int32  `gorm:"not null;index;type:varchar(32)" json:"city_code"`             // 城市代码
	AreaCode     int32  `gorm:"not null;index;type:varchar(32)" json:"area_code"`             // 地区代码
