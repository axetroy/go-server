...
func TestGetDefault(t *testing.T) {
	...
	// 还没有添加地址的话，获取默认地址应该会报错
	{
		...
		assert.Equal(t, address.ErrDefaultAddressNotExist.Error(), r.Message)
...
func TestGetDefaultRouter(t *testing.T) {
	...
	// 获取默认地址
	{
		r := tester.HttpUser.Get("/v1/address/default", nil, &header)
		...
		defaultAddress := address_schema.Address{}
