...
func GetDefault(context schema.Context) (res schema.Response) {
	var (
		err  error
...
func GetDefaultRouter(ctx *gin.Context) {
	var (
		err error
		res = schema.Response{}
	)
