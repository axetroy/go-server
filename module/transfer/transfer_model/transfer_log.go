...
var (
	...
	TransferLogCnyTableName  = transferLogTablePrefix + strings.ToLower(wallet_model.WalletCNY)  // 人民币表名
	TransferLogUsdTableName  = transferLogTablePrefix + strings.ToLower(wallet_model.WalletUSD)  // 美元表名
	TransferLogCoinTableName = transferLogTablePrefix + strings.ToLower(wallet_model.WalletCOIN) // 积分表名
	...
	TransferLogMap = map[string]interface{}{
		wallet_model.WalletCNY:  TransferLogCny{},
		wallet_model.WalletUSD:  TransferLogUsd{},
		wallet_model.WalletCOIN: TransferLogCoin{},
	}
)
