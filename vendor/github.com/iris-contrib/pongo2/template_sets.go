...
func (set *TemplateSet) BanTag(name string) error {
	...
	if set.firstTemplateCreated {
		return fmt.Errorf("you cannot ban any tags after you've added your first template to your template set")
	}
...
func (set *TemplateSet) BanFilter(name string) error {
	...
	if set.firstTemplateCreated {
		return fmt.Errorf("you cannot ban any filters after you've added your first template to your template set")
	}
