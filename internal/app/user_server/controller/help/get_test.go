...
import (
	"encoding/json"
	helpAdmin "github.com/axetroy/go-server/internal/app/admin_server/controller/help"
...
func TestGetHelp(t *testing.T) {
...

	{
		...
		// 2. 创建作为测试
		{
			...
			r := helpAdmin.Create(helper.Context{
				Uid: adminInfo.Id,
			}, helpAdmin.CreateParams{
				Title:   title,
				Content: content,
				Tags:    []string{},
			...
			defer helpAdmin.DeleteHelpById(n.Id)
		}
